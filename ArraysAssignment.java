...
//import classes to permit actions
...
public class ArraysAssignment {
    ...
    public static void main(String[] args) {
        ...
        // COMMENT: Here we are resizing the array by creating a new array of size 5

        // and copying only the weekday elements (Monday-Friday) to it
